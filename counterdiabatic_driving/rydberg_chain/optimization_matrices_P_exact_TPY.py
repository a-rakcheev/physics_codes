...
for i, op_name1 in enumerate(names_list):
    for op_name2 in tqdm.tqdm(names_list2[i]):
        ...
        if op_name1 == op_name2:
            ...
            name = "/home/artem/Dropbox/bu_research/rydberg_chain/optimization_matrices_TPY/optimization_matrices_P_exact_" + op_name1.upper() + "_" + op_name2.upper() + "_TPY_l=" + str(l) + ".npz"
            name_diag = "/home/artem/Dropbox/bu_research/rydberg_chain/optimization_matrices_TPY/optimization_matrices_P_exact_diag_" + op_name1.upper() + "_" + op_name2.upper() + "_TPY_l=" + str(l) + ".npz"
