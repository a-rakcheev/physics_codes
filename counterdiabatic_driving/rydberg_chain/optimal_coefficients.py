...
# parameters
l = 1                                            # range cutoff for variational strings
res_g = 17                                        # logarithmic resolution
res_h = 17                                        # logarithmic resolution
...
# np.savez_compressed(prefix + name, gl=gl, hl=hl, c_g=coefficients_1, c_h=coefficients_2)
