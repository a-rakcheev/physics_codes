...
# kappa = float(sys.argv[8])                  # ratio of nn and nnn


# parameters
N = 6                       # number of spins
order = 7                  # order of variational gauge potential
cutoff = 4                  # string length cutoff
res = 60                    # resolution of the interval (0, 1) in s
T = 1000.0                   # protocol duration
s_initial = 0.3             # initial s
s_final = 0.9               # final s
kappa = 0.5                 # ratio of nn and nnn
...
h_0 = (-1) * h_x
h_1 = kappa * h_z1z - h_zz


h_sum = 0.5 * h_0 + 0.7 * h_1
h_deriv = h_1 - 0.56 * h_0
