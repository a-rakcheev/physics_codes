...
def optimize_agp(index_tuple):
    ...
    ham = 0.2 * h_z1z + h_zz - y * h_x - x * h_z
    ham_deriv_x = (-1) * h_z
    ham_deriv_y = (-1) * h_x
...
if __name__ == '__main__':
    ...
    xl = np.linspace(1.e-10, 1.5, res_x)
    yl = np.linspace(1.e-10, 1., res_y)
    ...
    name = "optimize_agp_ltfi_L" + str(L) + "_l" + str(l) + "_order" + str(order) + "_res_x" + str(
        res_x) + "_res_y" + str(res_y) + ".pkl"
