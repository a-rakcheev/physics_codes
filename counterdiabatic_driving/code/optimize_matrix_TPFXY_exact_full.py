...
for i, op_name_1 in enumerate(names):
    for op_name_2 in names[i + 1:]:
        ...
        size = num_op[l - 1]
        TPY_labels, TPY_coeffs = pauli_func.create_operators_TPFXY_compact(l, L, size)
        ...
        if rank == 0:
            ...
            name = "optimization_matrices_exact_P_" + op_name_1.upper() + "_" + op_name_2.upper() + "_TPFXY_l=" + str(l) + ".npz"
            save_npz(name, mat)