...
P_Z_ZZ = pauli_func.create_P_matrix_TP(C_z_labels, C_zz_labels, C_z_coeffs, C_zz_coeffs) / (tr_I * L)

print(sp.csr_matrix(P_Z_ZZ))


# name = "ltfi_optimization_matrices_P_Z_ZZ_L=" + str(L) + "_l=" + str(l) + ".npz"
# np.savez_compressed(name, P_Z_ZZ=P_Z_ZZ)
