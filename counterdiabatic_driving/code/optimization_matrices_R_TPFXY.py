...
for op_name1 in names:
    ...
    for op_name2 in names:
        ...
        TPY_labels, TPY_coeffs = pauli_func.create_operators_TPFXY_compact(l, L, num_op[l - 1])
        ...
        name = "optimization_matrices_R_exact_" + op_name1.upper() + "_" + op_name2.upper() + "_TPFXY_l=" + str(l) + ".npz"
