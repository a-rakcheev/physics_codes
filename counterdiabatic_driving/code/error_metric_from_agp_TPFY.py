...
name = prefix + "spectrum_TPFY_L" + str(L) + "_op0=" + op_name_0 + "_op1=" + op_name_1 + "_op2=" + op_name_2\
    ...
    for j in range(res_2 // step2):
        ...
        for n in range(1, size):
            ...
            if r == 0:
                ...
                operator_1 = A_1 - 1.j * h_deriv_1 / omega_n0
                A_1 = None
                ...
                operator_2 = A_2 + 1.j * h_deriv_2 / omega_n0
                A_2 = None
...
name = "error_metric_TPFY_L" + str(L) + "_l=" + str(l) + "_r=" + str(r) + "_op0=" + op_name_0 + "_op1=" + op_name_1 \
