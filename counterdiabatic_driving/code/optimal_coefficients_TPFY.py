...
# res_2 = 50  # number of grid points on y axis
...
# R matrices
name = "optimization_matrices/optimization_matrices_R_" + op_name_1.upper() + "_" + op_name_0.upper() + "_TPFY_l=" + str(
    l) + ".npz"
data = np.load(name)
R_1_0 = data["R"] * factor_1 * factor_0

name = "optimization_matrices/optimization_matrices_R_" + op_name_1.upper() + "_" + op_name_1.upper() + "_TPFY_l=" + str(
    l) + ".npz"
data = np.load(name)
R_1_1 = data["R"] * factor_1 * factor_1

name = "optimization_matrices/optimization_matrices_R_" + op_name_1.upper() + "_" + op_name_2.upper() + "_TPFY_l=" + str(
    l) + ".npz"
data = np.load(name)
R_1_2 = data["R"] * factor_1 * factor_2

name = "optimization_matrices/optimization_matrices_R_" + op_name_2.upper() + "_" + op_name_0.upper() + "_TPFY_l=" + str(
    l) + ".npz"
data = np.load(name)
R_2_0 = data["R"] * factor_2 * factor_0

name = "optimization_matrices/optimization_matrices_R_" + op_name_2.upper() + "_" + op_name_1.upper() + "_TPFY_l=" + str(
    l) + ".npz"
data = np.load(name)
R_2_1 = data["R"] * factor_2 * factor_1

name = "optimization_matrices/optimization_matrices_R_" + op_name_2.upper() + "_" + op_name_2.upper() + "_TPFY_l=" + str(
    l) + ".npz"
data = np.load(name)
...
# P matrices
# symmetric
name = "optimization_matrices/optimization_matrices_P_" + op_name_0.upper() + "_" + op_name_0.upper() + "_TPFY_l=" + str(
    l) + ".npz"
P_0_0 = sp.load_npz(name) * factor_0 * factor_0

name = "optimization_matrices/optimization_matrices_P_" + op_name_1.upper() + "_" + op_name_1.upper() + "_TPFY_l=" + str(
    l) + ".npz"
P_1_1 = sp.load_npz(name) * factor_1 * factor_1

name = "optimization_matrices/optimization_matrices_P_" + op_name_2.upper() + "_" + op_name_2.upper() + "_TPFY_l=" + str(
    l) + ".npz"
P_2_2 = sp.load_npz(name) * factor_2 * factor_2

# not symmetric, need to check if operators are ordered correctly
if path.exists(
        "optimization_matrices/optimization_matrices_P_" + op_name_0.upper() + "_" + op_name_1.upper() + "_TPFY_l=" + str(
                l) + ".npz"):
    name = "optimization_matrices/optimization_matrices_P_" + op_name_0.upper() + "_" + op_name_1.upper() + "_TPFY_l=" + str(
        l) + ".npz"
else:
    name = "optimization_matrices/optimization_matrices_P_" + op_name_1.upper() + "_" + op_name_0.upper() + "_TPFY_l=" + str(
        l) + ".npz"
P_0_1 = sp.load_npz(name) * factor_0 * factor_1
P_0_1 = P_0_1 + P_0_1.T

if path.exists(
        "optimization_matrices/optimization_matrices_P_" + op_name_0.upper() + "_" + op_name_2.upper() + "_TPFY_l=" + str(
                l) + ".npz"):
    name = "optimization_matrices/optimization_matrices_P_" + op_name_0.upper() + "_" + op_name_2.upper() + "_TPFY_l=" + str(
        l) + ".npz"
else:
    name = "optimization_matrices/optimization_matrices_P_" + op_name_2.upper() + "_" + op_name_0.upper() + "_TPFY_l=" + str(
        l) + ".npz"
P_0_2 = sp.load_npz(name) * factor_0 * factor_2
P_0_2 = P_0_2 + P_0_2.T

if path.exists(
        "optimization_matrices/optimization_matrices_P_" + op_name_1.upper() + "_" + op_name_2.upper() + "_TPFY_l=" + str(
                l) + ".npz"):
    name = "optimization_matrices/optimization_matrices_P_" + op_name_1.upper() + "_" + op_name_2.upper() + "_TPFY_l=" + str(
        l) + ".npz"
else:
    name = "optimization_matrices/optimization_matrices_P_" + op_name_2.upper() + "_" + op_name_1.upper() + "_TPFY_l=" + str(
        l) + ".npz"
