...
for op_name_1 in names:
    ...
    size = num_op[l - 1]
    TPY_labels, TPY_coeffs = pauli_func.create_operators_TPY_compact_exact(l, L, size)
    ...
    end_time = MPI.Wtime()
    print("Time:", end_time - start_time, rank, flush=True)
    ...
    if rank == 0:
        ...
        name = "optimization_matrices_exact_P_" + op_name_1.upper() + "_" + op_name_1.upper() + "_TPY_l=" + str(l) + ".npz"
        save_npz(name, mat)